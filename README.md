...
> *The best code is written by someone who never stops asking why.*

I am a self-taught Full Stack Developer and founder of **TECHNOCYRA**, a software and technological solutions company.
My path has been defined not by a classroom, but by relentless curiosity and the discipline to turn every problem into an opportunity to build something better.

Every system I encounter is a puzzle. Every bug, a lesson. Every deployment, a proof of concept for what persistence looks like in practice.
I do not just write software — I craft solutions, iterate on ideas, and stay ahead by treating learning as a non-negotiable part of the craft.
...
| **Backend** | `Python` · `APIs` · `Database` |
| **Infrastructure** | `Linux` · `Git & GitHub` · `Google Cloud` |
| **Methodology** | `SCRUM` · `UML` · `Prompt Engineering` |
...
*Carlos Andrés Rodríguez Ruiz · Full Stack Developer · Founder & CEO at [TECHNOCYRA](https://technocyra.github.io/) · Colombia*